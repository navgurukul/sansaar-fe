  ...
  },
  {
    ...
    },
    {
      ...
      validation: yup
        ...
        .required("Required"),
      options: [
        { name: "0", value: "Sunday" },{ name: "1", value: "Monday" },{ name: "2", value: "Tuesday" },
        { name: "3", value: "Wednesday" },{ name: "4", value: "Thursday" },{ name: "5", value: "Friday" },
    ...
    },
    {
      ...
      validation: yup
        .string()
        .oneOf(["1","2","3"], "Please select one")
        .required("Required"),
      options: [
        { name: "1", value: "one" },{ name: "2", value: "two" },{ name: "3", value: "three" },
        { name: "4", value: "four" },{ name: "5", value: "five" }
      ],
      customProps: {
        id: "",
